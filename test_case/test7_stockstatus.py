...
class LOCALEBUY(unittest.TestCase):
    """获取指定商品的库存状态"""
    def setUp(self):
        # self.base_url = 'http://test.api20read.hellodfs.com/products/514/stockstatus'
        self.base_url = 'http://api20read.hellodfs.com/products/514/stockstatus'

    def tearDown(self):
        pass

    def test7_stockstatus(self):
