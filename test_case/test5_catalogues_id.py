...
class LOCALEBUY(unittest.TestCase):
    """获取指定的分类方案的整棵分类树"""
    def setUp(self):
        # self.base_url = 'http://test.api20read.hellodfs.com/catalogues/514'
        self.base_url = 'http://api20read.hellodfs.com/catalogues/514'

    def tearDown(self):
        pass

    def test5_catalogues_id(self):
