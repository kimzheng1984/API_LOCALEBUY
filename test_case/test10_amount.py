...
class LOCALEBUY(unittest.TestCase):
    """获取指定用户购物车商品数量"""
    def setUp(self):
        # self.base_url = 'http://test.api20read.hellodfs.com/users/514/shoppingcart'
        self.base_url = 'http://api20read.hellodfs.com/users/514/shoppingcart'
        self.payload = {'token': 'DYfff3f213280a47d884ce983d8ed67a87'}

    def tearDown(self):
        pass

    def test10_amount(self):
