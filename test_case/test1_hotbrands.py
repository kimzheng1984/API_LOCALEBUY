...
class LOCALEBUY(unittest.TestCase):
    """获取热门品牌"""
    def setUp(self):
        # self.base_url = 'http://test.api20read.hellodfs.com/campaigns/hotbrands'
        self.base_url = 'http://api20read.hellodfs.com/campaigns/hotbrands'

    def tearDown(self):
        pass

    def test1_hotbrands(self):
