...
class LOCALEBUY(unittest.TestCase):
    """获取热搜关键词列表"""
    def setUp(self):
        # self.base_url = 'http://test.api20read.hellodfs.com/search/hotkeywords'
        self.base_url = 'http://api20read.hellodfs.com/search/hotkeywords'

    def tearDown(self):
        pass

    def test8_hotwords(self):
